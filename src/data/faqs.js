...
export const faqs = [
  ...
  { cat: 'Cost & value', q: 'Is a bespoke suit actually worth it?', a: "Yes, if you have a hard-to-fit body, a wedding coming, or you wear a suit weekly. For a suit you'll wear twice a year, made-to-measure is the smarter spend, and I'll tell you so. I'd rather you buy the right tier once than overspend to impress me." },
  ...
  { cat: 'Cost & value', q: 'Do you take a deposit?', a: "Half at the start, half on delivery. The first half covers the cloth, which is cut to you and can't be resold. Nothing is ordered until you have the full price in front of you and you're happy with it." },
  ...
  { cat: 'Cost & value', q: 'Are custom suits worth it?', a: "Yes, if you have a hard-to-fit body, a wedding coming, or you wear a suit weekly. For a suit you'll wear twice a year, made-to-measure is the smarter spend, and I'll tell you so. I'd rather you buy the right tier once than overspend to impress me." },
  { cat: 'Cost & value', q: 'Should I just buy off-the-rack and have it altered?', a: "Sometimes, yes, and I'll tell you when. If a rack suit fits your shoulders and balance, alterations can finish the job for less. If it doesn't, no alteration will save it, and made-to-measure is the right answer. Bring your build; I'll give you the truth in five minutes." },
  ...
  { cat: 'Bespoke, made-to-measure & off-the-rack', q: "What does 'fully canvassed' mean, and do I need it?", a: "The canvas is the inner layer that gives a jacket its shape. Fused jackets glue it; canvassed ones float it, so the cloth drapes and moulds to you over the years instead of bubbling. I don't fuse suits. Half canvas is my default, and full canvas goes into the dearer cloths where you'll feel the difference." },
  { cat: 'Bespoke, made-to-measure & off-the-rack', q: 'Another tailor altered my suit badly. Can you fix it?', a: "Often, yes. Bring it in and I'll tell you what can be recovered. Some work can be reversed or re-done; some can't, especially if cloth was cut away. Either way you'll leave knowing exactly where you stand, at no charge for the look." },
  ...
  // ── First fitting ─────────────────────────────────────────────
  { cat: 'Your first fitting', q: "I've never done this. What happens at the first fitting?", a: "We talk, I measure, we choose cloth. About 90 minutes, with coffee and no clock. The first consultation is free, and you leave with a plan, not a bill." },
  { cat: 'Your first fitting', q: 'Do I need to know what I want before I come?', a: "Not at all. Most men don't. Bring the occasion and a rough budget; I'll bring a career's worth of knowing what works. If you own a jacket you love, bring it; we'll measure what you already like." },
  { cat: 'Your first fitting', q: 'What should I bring or wear?', a: "Wear or bring the shirt and shoes you'd pair with the suit, so the proportions are true. A jacket you wear often helps too. Otherwise, just yourself." },
  ...
  { cat: 'Your first fitting', q: 'Does the first consultation cost anything?', a: "No. The first conversation is free and candid. If we work together, you get a firm quote before any cloth is cut." },
  ...
  { cat: 'Fit', q: 'Can a suit make me look slimmer or taller?', a: "It can. A clean shoulder line, the right button stance and the right trouser break lengthen and streamline you. It's tailoring, not a trick, and it only works when the suit is cut to your actual body." },
  ...
  { cat: 'Weddings', q: 'Should I match the bride and bridal party?', a: "Coordinate, don't match exactly. We tie the lining, tie or pocket square to the party's colours so the group hangs together in photographs without looking like a uniform. Bring a photo of the gown and the palette." },
  { cat: 'Weddings', q: 'Custom or rent for the wedding?', a: "Rentals fit a crowd, not a person, and it shows in the photos you keep forever. A custom suit costs more but fits only you and stays in your wardrobe. For a day your grandchildren will see in pictures, it's usually worth it." },
  { cat: 'Weddings', q: 'Do you make custom tuxedos?', a: "Yes. Midnight and black tuxedos with satin peak or shawl lapels, made to your measurements at the Vaughan studio. A tuxedo is the garment where fit shows most, which is exactly why it's worth having made rather than rented." },
  { cat: 'Weddings', q: 'Why do rental tuxedos fit so badly?', a: "Because a rental is cut for the average of every man who wore it before you. Satin lapels and a clean black line make a poor fit more visible, not less; every pull across the chest and gap at the collar shows. A made tuxedo sits clean because it's built to your body alone." },
  ...
  { cat: 'Weddings', q: 'What should the father of the bride or groom wear?', a: "Something coordinated with the party but a notch more classic: never louder than the groom, never more casual than the guests. If it's black tie, the fathers wear tuxedos too. I'll dress the fathers and the groom together so nothing in the family photos looks borrowed or out of step." },
  { cat: 'Weddings', q: 'Can you dress the groom, groomsmen and both fathers together?', a: "Yes, and that's the ideal. Measuring everyone against the same notebook keeps colour, lapel and detail consistent, and I can do it at the studio or on one house call. It's the easiest way to keep a whole wedding party coordinated." },
  ...
  { cat: 'Weddings', q: 'Is it weird if my suit is custom while the groomsmen rent?', a: "Not at all; it's traditional. The groom is supposed to stand apart; a made suit against rented ones looks intentional, not unfair. We coordinate colour and detail so the party looks deliberate in photographs, with you clearly at the centre of it." },
  ...
  { cat: 'Visiting & the traveling tailor', q: 'Do you come to my home or office?', a: "The studio is where I work, and it's where the fitting is properly done. I have gone out to a client before, but it's the exception rather than a service I advertise, and I decide case by case whether I can do it justice. Ask me, and I'll give you a straight yes or no." },
  { cat: 'Visiting & the traveling tailor', q: 'Which areas do you serve?', a: "Clients come from Vaughan, Thornhill, Toronto, North York, Richmond Hill, Markham and right across the GTA. The fitting itself happens at the studio, and it's worth the drive: an hour here saves three rounds of guessing." },
  { cat: 'Visiting & the traveling tailor', q: 'Do I need an appointment?', a: "Yes. Everything is by appointment, so you have the room, and my full attention, to yourself: one client at a time. Book online or call 647·458·0711." },
  ...
  { cat: 'Traditional & Jewish menswear', q: 'Where can I buy a bekishe or kapota without going to Brooklyn?', a: "Here, in Vaughan. I make bekishes and kapotas to your measurements, so there's no flying to New York and no guessing a ready-made size. Measured here or on a house call across the GTA, with the discretion the community expects." },
  ...
  { cat: 'Trust', q: 'Do people actually come back?', a: "Constantly. Fathers send their sons, grooms return for their business wardrobe, and some clients are on their fifth suit. My reviews average 4.7 stars, and most new clients arrive by word of mouth." },
  { cat: 'Trust', q: 'How do I tell if a tailor is actually good?', a: "Ask three things: does he measure you himself, will he tell you not to buy something, and can you see or feel his finished work? A good tailor talks you out of spending as often as into it. Come put those three questions to me; the first visit will answer them." },
  { cat: 'Trust', q: "How do I make sure I don't get ripped off going custom?", a: "Get the price in writing before any cloth is cut, insist on a fitting before final payment, and walk away from anyone who won't do both. That's my standard practice: written quote first, deposit for the cloth, and you see the suit on your body before we finish." },
