...
export const faqs = [
  ...
  { cat: 'Cost & value', q: 'Do you take a deposit?', a: "Yes. A deposit covers the cloth, which I cut to you and can't resell; the balance is due on delivery. We settle the exact terms at the consultation, before anything is ordered." },
  ...
  { cat: 'Timeline & fittings', q: 'Can you do a rush order?', a: "Sometimes, in 3–4 weeks, depending on the cloth and my bench that month. Call me and I'll tell you straight whether I can do it justice in the time, rather than promise and disappoint." },
  ...
  { cat: 'Visiting & the traveling tailor', q: 'Do you come to my home or office?', a: "Yes, that's the Traveling Tailor service. I bring the tape, the cloth book and the notebook to you, anywhere in the GTA. It's how many executives and wedding parties get measured." },
  { cat: 'Visiting & the traveling tailor', q: 'Which areas do you serve?', a: "Vaughan, Thornhill, Toronto, North York, Richmond Hill, Markham and across the GTA. Come to the studio, or for parties and busy clients, I come to you." },
