...
On cost: you never have to guess. The value is set with Sam directly, and the gift can be an open-value gift certificate so you decide what feels right. The full breakdown lives in [what a custom suit costs](/guides/what-a-custom-suit-costs), and the mechanics in [how a suit gift certificate works](/guides/how-a-suit-gift-certificate-works).
